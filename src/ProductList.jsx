...
function ProductList({ onHomeClick }) {
    ...
    const handleRemoveItemFromCart = (itemName) => {
      setAddedToCart((prevState) => ({
        ...prevState,
        [itemName]: false
      }))
                    ...
                    <div>
                      <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                        <h1 className='cart'>
                          ...
                          <span className="cart_quantity_count">{getTotalItemsAdded()}</span>
                        </h1>
                      </a>
                    </div>
                </div>
            ...
            {!showCart ? (
                <div className="product-grid">
                  {plantsArray.map((item, index) => (
                    <div key={`plants-array-item-${index}`}>
                      ...
                      <div className="product-list">
                        {item.plants.map((plant, plantIndex) => (
                          <div
                            key={`product-list-item-${index}-${plantIndex}`}
